...
# ready multi data frames analize --------------------------------------------------

# si8mplemente seleccionar los grupos deseados:
# se hara como modo de ejemplo con todo el df principal y dividido solo por clase
# en anfibios y reptiles

# all data
##################

# df principal igual al dfsub
# simplemente separar por grupos
list_main <- subgrupos()
View(list_main)

# transformar y dejar los df listos para analisis
# reemplazo valores faltantes de acuerdo a subgrupos, na, etcetera 
...
# lo mismo pero por grupos


desired_groups <- c("CLASE")  # se usara este para pruebas(es el mas obvio)
...
# list_prueba <- list_ready
# list_ready$Main <- list_main[[1]]
# View(list_ready)
...
# ya se puede dividir en cualesquiera subgrupos y dejar listos los dfs
# para cualquier analisis
