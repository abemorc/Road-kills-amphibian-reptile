...
# presentar las tablas con una columna del indice de correlacion spearman y
# otra columna de su significancia
...
# despues de contruir todos los modelos posibless y compararlos bajo el
...
## La funcion log tiene desempeño ligeramente superior
